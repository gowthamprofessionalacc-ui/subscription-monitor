// OTT Theme Configuration
// Contains colors, gradients, and styling for each OTT platform
...
// Get theme by OTT name
const getTheme = (ottName) => {
...
module.exports = { ottThemes, getTheme, getAllThemes };
